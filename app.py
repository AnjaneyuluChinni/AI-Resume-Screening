...
if uploaded_file and jd:
    ...
    # Use Groq LLM to extract skills, education, experience
    ...
    if not jd_skills:
        # Try to extract skills from JD using Groq LLM
        ...
        try:
            jd_skills = json.loads(skill_response.choices[0].message.content)
        except Exception:
            jd_skills = []
